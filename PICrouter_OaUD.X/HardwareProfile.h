 ...
 *
 * HardwareProfile.c,v.0.2 2012/09/06
 */
...
#define HARDWARE_PROFILE_H
    ...
    // LED_PAD_16
    #define LD_LOAD(state) AD_PORT2_OUT(state);
    #define SR_SL(state)   AD_PORT3_OUT(state);
    #define SR_CLK(state)  AD_PORT4_OUT(state);
    #define SR_QH()        AD_PORT5_IN();
